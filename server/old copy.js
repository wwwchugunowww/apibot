...
//   // const username = msg.chat.username || "Не указан"; // Получение никнейма пользователя
//   console.log(msg, "msg!!")
//   try {
//     // Отправляем номер телефона, ID чата и никнейм на сервер
//     //http://localhost:5000/merchant/userbots/search?phoneNumber=+380638532509
...
//     // Отправляем пользователю ответ от сервера
//     bot.sendMessage(chatId, response.data.telephone_telegram);
//     // bot.sendMessage(chatId, `Сервер ответил: ${response.data}`);
//   } catch (error) {
//     console.error("Ошибка при отправке запроса на сервер:", error);
//     bot.sendMessage(
//       chatId,
//       "Произошла ошибка при отправке вашего номера на сервер."
//     );
//   }
// });
